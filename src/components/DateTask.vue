...
<template>
    <div class="task-container">
        ...
        <div class="flex flex-row gap-3 items-center">
            ...
            <!-- === Date Dropdown === -->
            <Dropdown v-model="task.Date.year" :options="[
                ...
                class="flex-1" @change="emit('update')" />

            <!-- === Month Dropdown === -->
            <Dropdown v-model="task.Date.month" :options="[
            ...
            <!-- === Day Dropdown === -->
            <Dropdown v-model="task.Date.day" :options="[
            ...
            <div class="flex">
                <FloatLabel variant="on">
                    <InputText class="w-21" v-model="task.Date.separator"
            ...
            <div class="flex-1">
                <ToggleButton v-model="task.Date.at_start" onLabel="@ Start"
